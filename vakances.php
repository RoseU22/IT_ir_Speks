...
<head>
    ...
    <link rel="stylesheet" href='assets/styles/vakances.css'>
...
<body>
    ...
    <header>
        ...
        <nav>
            ...
            <a href="index.php#vakances">Vakances</a>
        ...
        <div class="meklet">
                ...
                <form action="#">
                    ...
                    <input type="text" placeholder="Meklēt vakances" name="meklet">
    ...
    <div class="visasvakances">

        <table class="vakancesKaste">
